      ...
      <div class="container_contact">
            ...
            <div class="form">
              <div class="contact-info">
                <h3 class="title" style="color:#fe6686;">Espace medecin</h3>
                <img src="assets/Sign up-amico.svg"  alt="" />
              ...
              <div class="contact-form">
                ...
                <form action=""  method="POST" >
                  ...
                  <input type="text"  class="input"  name="secondname" value ="<?php if(isset($_POST['submit'])){ echo $secondname ;} ?>">
                    ...
                    <!-- cin -->
                    <div class="input-container">
                  <input type="text" name= "cin"  class="input" class="input" value ="<?php if(isset($_POST['submit'])){ echo $cin ;} ?>" >
                    <label for="">Cin</label>
                    <span>Cin</span>
                  </div>
                  ...
                  <!-- numero -->
                 <div class="input-container">
                  <input type="tel"  name="numero" class="input" value ="<?php if(isset($_POST['submit'])){ echo $numero ;} ?>">
                  ...
                  <div class="input-container">
                  <select name="specialite" id="" class="specialite input"  >
                    <?php
                 ...
                 ?>
                  ...
                  <!-- adresse -->
                  <div class="input-container">
                  <input type="text" name="adresse" class="input adr-ville" id="adress"  value ="<?php if(isset($_POST['submit'])){ echo $adresse ;} ?>" >
                    <label for="">Adresse</label>
                    <span>Adresse</span>
                  </div>
                  <!-- ville -->
                  <div class="input-container">
                  <select name="ville" id="" class="specialite input"  >
                    <?php
