...
elseif(empty($cin) == true){
  $msg ="<p class='alert-red'> veuillez remplir le champ cin </p> ";
...
elseif(empty($specialite) == true){
  $msg ="<p class='alert-red'> veuillez remplir le champ spacialite </p> ";

}
elseif(empty($adresse) == true){
  $msg ="<p class='alert-red'> veuillez remplir le champ adresse </p> ";

}
elseif(empty($ville) == true){
  $msg ="<p class='alert-red'> veuillez remplir le champ ville </p> ";
    ...
    if ($result) {
        echo "<div style='display: none;'>";
                ...
                try {
                    ...
                    $mail->Subject = 'Shifae';
                    $mail->Body  = '<html><body><img src="https://recruteur.lefigaro.fr/wp-content/uploads/2022/02/FR_welcome_pack.jpg" width="160" height="120" border-radius="10%" alt="logo" /></a><h1> <i> Shifae  </i> </h1> </br> <h4 style="color:#fe6686;"> <u> Bonjour '.$firstname.' </u></h4> <p>bienvenue dans  l\'espace medecin de notre site Shifae voici le lien de validation de votre compte    </p> </br></br> <b><a href="http://localhost/cabinetProject/connexionDoc/?verification='.$code.'">http://localhost/cabinetProject/connexionDoc/?verification='.$code.'</a></b> </body></html>';
                ...
                echo "</div>";
    $msg ="<p class='alert-blue'> nous avons vous envoyer un email de vérification! </p> ";

    }
    else{
    $msg ="<p class='alert-green'> quelque chose ça marche pas! </p> ";
