...
include "configChangepassword.php";
?>
...
<body>
 ...
 <div class="login-container">
       <div class="contenu ">
        <h3 class="title1">Changer le mot de passe</h3>
        <p class="precup"> Pour réinitialiser votre mot de passe ,saisissez votre nouveau mot de passe .</p>
        <?php echo $msg; ?> 
        <!-- <label for="" class="precup">Adresse e-mail</label></br> -->
        <form action="" method="post" class="form">
        <input type="password" name="password" class="emailreup" placeholder="  nouveau mot de passe " >
        <input type="password" name="confirmpassword" class="emailreup" placeholder=" confirmer mot de passe" >
</br>
        <input type="submit" name="submit" value="Changer mot de passe" class="envoyerforget" >
</br>
</form>
       </div>
