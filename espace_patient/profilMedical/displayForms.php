...
function insert_diagno()
{
  ...
  <form action="" method="post" name="diagno" class="form border insert" id="diagno-form">
              ...
              <label >
                ...
                <label >
                  Diagnostique :
                    <textarea name="diago"  id="diago"  rows="4" placeholder=" Diagnostique... "></textarea>
                </label><label >
                Prescription d\'examens complémentaires :
                    <textarea name="exam"  id="exam"  rows="4" placeholder="(Si necessaire).... "></textarea>
                </label><label >
                Prescription d\'un traitement  :
                    <textarea name="traite"  id="traite"  rows="4" placeholder=" (ordonnance, geste technique...) "></textarea>
                </label>
...
function update_diagno() {
  ...
  <form action="" method="post" name="diagno" class="form border update" id="diagno-form-update">
    <button class="close_form" id="diagno-btn-close" name="close-update-diagno"> <i class="uis uis-multiply closer"></i> </button> 
        ...
        <label >
          Diagnostique :
            <textarea name="diag1"  id="diag1"  rows="4" placeholder=" Diagnostique... "></textarea>
        </label><label >
        Prescription d\'examens complémentaires :
            <textarea name="exam1"  id="exam1"  rows="4" placeholder="(Si necessaire).... "></textarea>
        </label><label >
        Prescription d\'un traitement  :
            <textarea name="traite1"  id="traite1"  rows="4" placeholder=" (ordonnance, geste technique...) "></textarea>
        </label>
