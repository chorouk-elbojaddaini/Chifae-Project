...
if(($_POST['formType'])=='diagno' )
{
    ...
    //--------maladies-------------
    $malad = mysqli_query($conn,"INSERT INTO diagnostic(nomComplet,specialite,diagnostic,exam,traitement) VALUES ('$name','$spec','$diag','$exam','$traite')");
...
if($check === false){
   $res = [
       'status' => 422,
       'message' => 'fichier n est pas une image '
       ];
       echo json_encode($res);
       return;
}
