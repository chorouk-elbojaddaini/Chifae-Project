        ...
        <?php
          ...
          <img id="photoD"   src="data:image;base64,<?php echo $_SESSION['photo_doctor'] ;?>" border-radius="50%" class="imageNavbar">
           ...
           <?php
              ...
              ?>
                <img  src="images/noprofil.jpg" alt="profile" id="photoD" class="imageNavbar imgNav">
       ...
       <div class="overlay profil hide over-prof" id="profil" >
                ...
                // echo  $_SESSION['dateMal'] ;
                    ...
                    <p><i class='fa-solid fa-circle-exclamation warning'></i>Aucun résultat n'est trouvé</p>
                            ...
                            for ($i=1; $i <= $total_pages ; $i++){  
                                echo "<a class='pagination'href='?code_patient=".$_SESSION['code_patient']."&pageM=".$i."#maladieS'>".$i."</a>" ;
                              } 
                              echo'</div>';
           ...
           <div  class="section">
                ...
                <?php 
                    ...
                    <p><i class='fa-solid fa-circle-exclamation warning'></i>Aucun résultat n'est trouvé</p>
                            ...
                            for ($i=1; $i <= $total_pages ; $i++){  
                                echo "<a class='pagination'href='?code_patient=".$_SESSION['code_patient']."&pageT=".$i."#traiteS'>".$i."</a>" ;
                              } 
                              echo'</div>';
           ...
           <div  class="section">
                ...
                <?php 
                    ...
                    <p><i class='fa-solid fa-circle-exclamation warning'></i>Aucun résultat n'est trouvé</p>
                            ...
                            for ($i=1; $i <= $total_pages ; $i++){  
                                echo "<a class='pagination'href='?code_patient=".$_SESSION['code_patient']."&pageH=".$i."#hospitalS'>".$i."</a>" ;
                              } 
                              echo'</div>';
                    ...
                    <button type="button" class="open-form" id="add-allergy" onclick="displayForm('allergy')">Ajouter</button>
                      ...
                      <?php 
                        ...
                        <p><i class='fa-solid fa-circle-exclamation warning'></i>Aucun résultat n'est trouvé</p>
                                ...
                                for ($i=1; $i <= $total_pages ; $i++){  
                                    echo "<a class='pagination'href='?code_patient=".$_SESSION['code_patient']."&pageAl=".$i."#allergieS'>".$i."</a>" ;
                                  } 
                                  echo'</div>';
           ...
           <div class="section">
                ...
                <?php 
                    ...
                    <p><i class='fa-solid fa-circle-exclamation warning'></i>Aucun résultat n'est trouvé</p>
                            ...
                            for ($i=1; $i <= $total_pages ; $i++){  
                                echo "<a class='pagination'href='?code_patient=".$_SESSION['code_patient']."&pageV=".$i."#vaccinS'>".$i."</a>" ;
                              } 
                              echo'</div>';
           ...
           <div  class="section">
              ...
              <div class="filters">
                    ...
                    <p><i class='fa-solid fa-circle-exclamation warning'></i>Aucun résultat n'est trouvé</p>
                            ...
                            for ($i=1; $i <= $total_pages ; $i++){  
                                echo "<a class='pagination'href='?code_patient=".$_SESSION['code_patient']."&pageMes=".$i."#mesureS'>".$i."</a>" ;
                              } 
                              echo'</div>';
               ...
               <?php 
                ...
                <?php 
                    ...
                    <p><i class='fa-solid fa-circle-exclamation warning'></i>Aucun résultat n'est trouvé</p>
                            ...
                            for ($i=1; $i <= $total_pages ; $i++){  
                                echo "<a class='pagination'href='?code_patient=".$_SESSION['code_patient']."&pageAn=".$i."#antecedentS'>".$i."</a>" ;
                              } 
                              echo'</div>';
                    ?>
           ...
           <div class="filters">
                    ...
                    <p><i class='fa-solid fa-circle-exclamation warning'></i>Aucun résultat n'est trouvé</p>
                            ...
                            for ($i=1; $i <= $total_pages ; $i++){  
                                echo "<a class='pagination'href='?code_patient=".$_SESSION['code_patient']."&pageD=".$i."#documentS'>".$i."</a>" ;
                              } 
                              echo'</div>';
           ...
           <button type="button" class="open-form" id="add-diagno" onclick="displayForm('diagno');">Ajouter </button> 
                  ...
                  <p><i class='fa-solid fa-circle-exclamation warning'></i>Aucun résultat n'est trouvé</p>
                          ...
                          for ($i=1; $i <= $total_pages ; $i++){  
                              echo "<a class='pagination'href='?code_patient=".$_SESSION['code_patient']."&pageDg=".$i."#diagnosticS'>".$i."</a>" ;
                            } 
                            echo'</div>';
