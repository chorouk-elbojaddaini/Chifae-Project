...
<body>
 ...
 <div class="login-container">
       <div class="contenu ">
        <h3 class="title1">Vous avez oublié votre mot de passe?</h3>
        <p class="precup"> Pour réinitialiser votre mot de passe ,saisissez l'adresse e-mail que vous utilisez pour vous connecter à votre compte Shifae . Il peut s'agir de votre adresse Gmail ou Google Apps , ou d'une autre adresse e-mail que vous avez associée à votre compte.</p>
        <?php echo $msg; ?>
        <label for="" class="precup">Adresse e-mail</label></br>
        <form action="" method="post">
        <input type="email" name="email" class="emailreup" placeholder="votre adresse e-mail" >
</br>
        <input type="submit" name="submit" value="ENVOYER" class="envoyerforget" >
</br>
</form>
<p>Si vous ne possédez pas encore de compte Shifae .vous pouvez en  <a href="../inscriptionPatient/inscription.php" style="color:blue;">&nbsp; créer un maintenant.</a></p>
       </div>
