...
require '../inscriptionPatient/vendor/autoload.php';
include '../cnx.php';
$msg ="";
...
$query = mysqli_query($conn, "UPDATE patient SET code= '{$code}' WHERE email = '{$email}'");
if($query){
